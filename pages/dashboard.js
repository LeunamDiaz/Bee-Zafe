...
export default function Demo() {
    ...
    <header class="flex items-center h-20 px-6 sm:px-10 bg-white">
      ...
      <div class="flex flex-shrink-0 items-center ml-auto">
        <button class="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
          ...
          <Image src="" alt="user profile photo" class="h-full w-full object-cover"></Image>
          </span>
    ...
    <main class="p-6 sm:p-10 space-y-6">
      <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        ...
        <div class="flex flex-wrap items-start justify-end -mb-3">
          ...
          <button class="inline-flex px-5 py-3 text-black-500 hover:text-amber-700 focus:text-amber-500 hover:bg-amber-100 focus:bg-amber-100 border border-amber-500 rounded-md mb-3">
  ...
  <h2 class="text-2xl font-bold">Colmena 1</h2>
</div>
            ...
            <ul class="p-6 space-y-6">
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Annette Watson profile picture"></Image>
                </div>
              ...
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Calvin Steward profile picture"></Image>
                </div>
              ...
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Ralph Richards profile picture"></Image>
                </div>
              ...
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Bernard Murphy profile picture"></Image>
                </div>
              ...
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Arlene Robertson profile picture"></Image>
                </div>
              ...
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Jane Lane profile picture"></Image>
                </div>
              ...
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Pat Mckinney profile picture"></Image>
                </div>
              ...
              <li class="flex items-center">
                <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="" alt="Norman Walters profile picture"></Image>
                </div>
