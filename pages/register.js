 ...
 <div>
	...
	<div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form className="bg-white">
			<h1 className="text-gray-800 font-bold text-2xl mb-1">Unete a Bee Zafe</h1>
			...
			<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
				...
				<input className="pl-2 outline-none border-none" type="text" name="" id="" placeholder="Nombre completo" style={{ color: 'black' }} // Asegúrate de que el color sea visible contra el fondo del input
/>
      </div>
				<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
...
/>
					...
					<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<input className="pl-2 outline-none border-none" type="text" name="" id="" placeholder="Correo eléctronico Address" style={{ color: 'black' }} // Asegúrate de que el color sea visible contra el fondo del input
/>
      </div>
